...
const int BacklightColors::LIME[3] = {127, 255, 10};
const int BacklightColors::GREEN[3] = {10, 255, 10};
const int BacklightColors::TEAL[3] = {10, 255, 127};
const int BacklightColors::CYAN[3] = {10, 255, 255};
const int BacklightColors::SKY[3] = {10, 127, 255};
